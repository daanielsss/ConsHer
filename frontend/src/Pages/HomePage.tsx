...
export default function HomePage() {
    ...
    const { data: houses, isLoading } = useQuery("catalogo-casas", async () => {
    ...
    const preventa = houses?.filter((h: any) => h.status === "preventa") || [];
    const disponibles = houses?.filter((h: any) => h.status === "disponible") || [];
    const vendidas = houses?.filter((h: any) => h.status === "vendida") || [];
